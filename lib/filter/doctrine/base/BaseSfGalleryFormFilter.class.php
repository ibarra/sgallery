...
/**
 * SfGallery filter form base class.
 *
 * @package    sp_gallery
 * @subpackage filter
 ...
 */
abstract class BaseSfGalleryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('sf_gallery_filters[%s]');
